...
**Matematik Öğreniyorum**, matematiği sevdirmeyi ve temel işlemleri keyifli bir deneyimle sunmayı amaçlayan modern bir eğitim uygulamasıdır. Oyunlaştırılmış yapısı ve seviyeli ilerleme modeli ile öğrenmeyi bir oyun haline getirir.

---

## 🚀 Temel Özellikler

Uygulama, her seviyeden öğrenciye hitap eden dinamik bir yapıya sahiptir:

* **🧮 Kademeli Zorluk:** Seviye 1'den Seviye 5'e kadar, tek basamaklıdan beş basamaklı işlemlere uzanan geniş içerik.
* **⭐ Rozet Sistemi:** Puan toplayarak Bronz, Gümüş ve Altın **Panda Rozetleri** kazanın!
* **🎧 Sesli Destek:** Sayıları ve işlemleri sesli dinleme özelliği ile işitsel öğrenme desteği.
* **📊 İstatistik Paneli:** Toplam puan, doğru/yanlış sayısı ve gelişim takibi.
